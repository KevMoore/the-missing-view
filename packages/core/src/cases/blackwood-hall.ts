...
export const blackwoodHall: CasePack = {
  ...
  clues: [
    // ---- Act 1: the body, the house, the first threads ----
    {
      ...
      act: 1,
      key: true,
      imageAsset: '/art/blackwood-hall/evidence/c-diary.jpg',
      moment: 'detail',
      implicates: ['s-cross', 's-reeves'],
    ...
    },
    {
      ...
      act: 1,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-clock.jpg',
      moment: 'detail',
    ...
    },
    {
      ...
      act: 1,
      key: true,
      imageAsset: '/art/blackwood-hall/evidence/c-ledger.jpg',
      moment: 'big-picture',
      implicates: ['s-cross'],
    ...
    },
    {
      ...
      act: 1,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-row.jpg',
      moment: 'conflict',
      implicates: ['s-ashworth'],
    ...
    },
    {
      ...
      act: 1,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-cuff.jpg',
      moment: 'challenge',
      implicates: ['s-ashworth'],
    ...
    },
    {
      ...
      act: 1,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-pearls.jpg',
      moment: 'big-picture',
      implicates: ['s-margaret'],
    ...
    },
    {
      ...
      act: 1,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-bolts.jpg',
      moment: 'synthesis',
    ...
    },
    {
      ...
      act: 1,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-thread.jpg',
      moment: 'detail',
    ...
    // ---- Act 2: the lies begin to show ----
    {
      ...
      act: 2,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-letter.jpg',
      moment: 'big-picture',
      implicates: ['s-margaret', 's-cross'],
    ...
    },
    {
      ...
      act: 2,
      key: true,
      imageAsset: '/art/blackwood-hall/evidence/c-typewriter.jpg',
      moment: 'listening',
      implicates: ['s-cross'],
    ...
    },
    {
      ...
      act: 2,
      key: true,
      imageAsset: '/art/blackwood-hall/evidence/c-light.jpg',
      moment: 'listening',
      implicates: ['s-cross'],
    ...
    },
    {
      ...
      act: 2,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-found.jpg',
      moment: 'challenge',
      // Reads as a confession and is the opposite of one. With the stopped
      // clock at 12:04 his own account clears him: he came down twenty-six
      // minutes after the fall. The guilt was always fear, never murder.
      exonerates: ['s-ashworth'],
    ...
    },
    {
      ...
      act: 2,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-morphia.jpg',
      moment: 'conflict',
      implicates: ['s-harmsworth'],
    ...
    },
    {
      ...
      act: 2,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-constable.jpg',
      moment: 'leadership',
    ...
    // ---- Act 3: the missing view assembles ----
    {
      ...
      act: 3,
      key: true,
      imageAsset: '/art/blackwood-hall/evidence/c-keys.jpg',
      moment: 'decision',
      implicates: ['s-cross', 's-reeves'],
      exonerates: ['s-margaret', 's-ashworth', 's-harmsworth'],
    ...
    },
    {
      ...
      act: 3,
      key: true,
      imageAsset: '/art/blackwood-hall/evidence/c-photo.jpg',
      moment: 'synthesis',
      implicates: ['s-cross'],
    ...
    },
    {
      ...
      act: 3,
      key: false,
      imageAsset: '/art/blackwood-hall/evidence/c-alibi.jpg',
      moment: 'conflict',
      // A mutual alibi across 12:04, given by two people who plainly loathed
      // having to give it.
      exonerates: ['s-margaret', 's-harmsworth'],
    ...
    },
    {
      ...
      act: 3,
      key: true,
      imageAsset: '/art/blackwood-hall/evidence/c-coat.jpg',
      moment: 'detail',
      implicates: ['s-cross'],
      exonerates: ['s-reeves'],
